...
global.ownername= "{‹»D$›»}™" //nama kalian
global.myweb ="https://github.com/defan312/" //bebas asal jan hapus
...
global.owner = ["6282135905896","6282135905896","6282135905896"] //ganti agar fitur owner bisa di gunakan
global.packname = '© {‹»D$›»}' //sticker wm ubah
global.author = 'Di Buat Oleh defan' //sticker wm ganti nama kalian
...
global.mess = {
    ...
    wait: '⏳ Sedang Di Proses cuk',
	lockCmd: 'Fitur Tidak Diaktifkan Oleh Owner!',
	example1: 'Selamat Datang Beban @user Di Group @subject Jangan Lupa Baca Rules @desc\n\nNote :\n1. @user (Mention User Join)\n2. @bio (Get Bio User Join)\n3. @tanggal (Date Now)\n4. @desc (Get Description Group)\n5. @subject (Group Name)'
}
